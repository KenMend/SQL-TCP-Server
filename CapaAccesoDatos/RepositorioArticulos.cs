...
namespace CapaAccesoDatos
{
    ...
    public static class RepositorioArticulos
    {
        //Eliminamos todos los arrays estáticos y los métodos también.
        //van a ser reemplazados con DAL en CapaAccesoDatosSql
